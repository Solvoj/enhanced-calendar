define([
	...
	var EnhancedCalendar = declare("widget.EnhancedCalendar",[CalendarLite, _Widget, _CssStateMixin], {
		// summary:
		//		A simple GUI for choosing a date in the context of a monthly calendar. 
		//		Enhanced Calendar based on the dojo component Calendar 
		//		that can show both Gregorian and Hijri calendar at the same time. 
		//
		// description:
		//		See EnhancedCalendarLite for general description.   EnhancedCalendar extends EnhancedCalendarLite, adding:
		//
		//		- month drop down list
		//		- keyboard navigation
		//		- CSS classes for hover/mousepress on date, month, and year nodes
		//		- support of deprecated methods (will be removed in dojo 2.0)
...
//
//			return new EnhancedCalendar._MonthDropDownButton({
//				id: this.id + "_mddb",
//				tabIndex: -1,
...
//		},
		...
		postCreate: function(){
			...
			// Events specific to EnhancedCalendar, not used in EnhancedCalendarLite
			this.own(
		...
		handleKey: function(/*Event*/ evt){
			...
			//		and also from `_EnhancedDateTimeTextBox` to pass a keydown event
			//		from the `EnhancedDateTimeTextBox` to be handled in this widget
			// returns:
		...
		onValueSelected: function(/*Date*/ /*===== date =====*/){
			...
			// description:
			//		Formerly used by `com/solvoj/widget/_DateTimeTextBox` (and thus `com/solvoj/widget/DateTextBox`)
	...
	EnhancedCalendar._MonthDropDownButton = declare("widget.EnhancedCalendar._MonthDropDownButton", DropDownButton, {
		// summary:
		...
		postCreate: function(){
			this.inherited(arguments);
			this.dropDown = new EnhancedCalendar._MonthDropDown({
	...
	EnhancedCalendar._MonthDropDown = declare("widget.EnhancedCalendar._MonthDropDown", [_Widget, _TemplatedMixin], {
		// summary:
