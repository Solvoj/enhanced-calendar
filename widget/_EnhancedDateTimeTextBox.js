define([
	...
	var _EnhancedDateTimeTextBox = declare("widget._EnhancedDateTimeTextBox",[RangeBoundTextBox, _HasDropDown], {
		// summary:
		...
		/*=====
		// constraints: _EnhancedDateTimeTextBox.__Constraints
		//		Despite the name, this parameter specifies both constraints on the input
		//		(including starting/ending dates/times allowed) as well as
		//		formatting options like whether the date is displayed in long (ex: December 25, 2005)
		//		or short (ex: 12/25/2005) format.  See `com/solvoj/widget/_EnhancedDateTimeTextBox.__Constraints` for details.
		constraints: {},
		======*/
		...
		openDropDown: function(/*Function*/ callback){
			...
			this.dropDown = new PopupProto({
				...
				showHijri:textBox.showHijri,
				showGregorian:textBox.showGregorian,
				isDisabledDate: function(/*Date*/ date){
					// summary:
					//		disables dates outside of the min/max of the _EnhancedDateTimeTextBox
	...
	/*=====
	 _EnhancedDateTimeTextBox.__Constraints = declare([RangeBoundTextBox.__Constraints, locale.__FormatOptions], {
		 // summary:
	...
	return _EnhancedDateTimeTextBox;
});
